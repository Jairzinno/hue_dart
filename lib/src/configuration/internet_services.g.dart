...
class _$InternetServicesSerializer
  ...
  @override
  Iterable serialize(Serializers serializers, InternetServices object,
  ...
  @override
  InternetServices deserialize(Serializers serializers, Iterable serialized,
      {FullType specifiedType = FullType.unspecified}) {
...
class _$InternetServices extends InternetServices {
  ...
  factory _$InternetServices([void updates(InternetServicesBuilder b)]) =>
  ...
  @override
  InternetServices rebuild(void updates(InternetServicesBuilder b)) =>
...
class InternetServicesBuilder
  ...
  @override
  void update(void updates(InternetServicesBuilder b)) {
